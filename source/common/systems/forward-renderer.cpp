...
namespace our {
    ...
    void ForwardRenderer::initialize(glm::ivec2 windowSize, const nlohmann::json& config){
        ...
        if(config.contains("sky")){
            ...
            // enable depthTesting and faceCulling and assign GL_EQUAL to depthTesting function and GL_FRONT to culledFace
        ...
        if(config.contains("postprocess")){
            ...
            //  use empty function to create the 2 textures
            ...
            // we bind frameBuffer to attach textures to it
    ...
    void ForwardRenderer::render(World* world){
        ...
        // first, get view matrix from camera component
        glm::mat4 cameraViewMatrix = camera->getViewMatrix();
        glm::vec3 cameraForward = cameraViewMatrix[2];
        ...
        // second, get projection matrix from camera component using window size property
        glm::mat4 cameraProjectionMatrix = camera->getProjectionMatrix(this->windowSize);
        // third, get VP matrix by multiplying projection * view
        glm::mat4 VP = cameraProjectionMatrix * cameraViewMatrix;

        //TODO: (Req 9) Set the OpenGL viewport using viewportStart and viewportSize

        // starting x, y, and width and height
        ...
        if(this->skyMaterial){
            ...
            // use setup function in Material class
