...
bool our::ShaderProgram::attach(const std::string &filename, GLenum type) const
{
    ...
    std::string shader_error_string = checkForShaderCompilationErrors(shader);
    if (shader_error_string == "")
    {
    ...
    {
        std::cout << shader_error_string << std::endl;
        return false;
    }
}
...
bool our::ShaderProgram::link() const
{
    ...
    std::string linking_error_string =checkForLinkingErrors(program);
    if (linking_error_string == "")
    {
