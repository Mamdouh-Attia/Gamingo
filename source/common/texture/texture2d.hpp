...
namespace our {
    ...
    public:
        ...
        Texture2D() {
            ...
            //calling glGenTextures() to create 1 texture
        ...
        ~Texture2D() { 
            //TODO: (Req 5) Complete this function
            //calling glDeleteTextures() to delete one texture with the object name "name"
        ...
        void bind() const {
            //TODO: (Req 5) Complete this function
            //calling glBindTexture() to bind this texture to GL_TEXTURE_2D
        ...
        static void unbind(){
            //TODO: (Req 5) Complete this function
            //calling glBindTexture() to unbind any texture from GL_TEXTURE_2D
